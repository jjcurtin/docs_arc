...
- fg %1 to move orogram to foreground
- bg %1 to kove to background
...
- `tar czf playground.tgz playground` to archive and compress (coukd also name playground.tar.gz)
