...
The VMs are administered through the [https://cci-one-vra-01.cci.wisc.edu/csp/gateway/portal/#/consumer](CCI Cloud Console). 
...
While viewing the list of VMs, click the 3-dot menu.
