...
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate1.png)

Pull the meter out of the suitcase and slip the metal sleeve over the meter:
 
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate2.png)
...
* ![The db range should be set to 100.](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate3.png)

* ![The Batt dial should be set to A on the slow side.](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate4.png)

* ![The frequency dial should be set to 250.](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate5.png)
...
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate6.png)
...
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/str_calibrate7.png)
...
2.	Open Neuroscan and select setup file that records probe channel and uses an event code hold value of 0 (e.g., [NoiseTest_SynAmps1.ast](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/NoiseTest_SynAmps1.ast); [NoiseTest_SynAmps2.ast](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/NoiseTest_SynAmps2.ast))
...
### Performing the Test
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/breakout_1.png)
...
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/displaytest1.png)
...
2.	Start Neuroscan and select a setup file with an event hold value of 0 and a channel to record output from the photoresistor. Example files can be used: [synamps2TestDisplay.ast](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/synamps2TestDisplay.ast).
...
![](https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/images/displaytest2.png)
 
DisplayTest.m Output

## Testing IO Output
[TestOutput.m]https://github.com/jjcurtin/psychophysiology/blob/main/hardware/hardware_testing/TestOutput.m) is used to test a single digital output from Stimulus Control computer. This can be on either port B or C (the two output ports). This can be used to test event codes to neuroscan or to test TTLs on port C (for external devices such as shocker).
...
# EEG
* [ERG Cap Cable Connector Pinouts](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/eeg_cap_cable_connector_pinouts.pdf)

## 32 Channel Caps
* [Channel Assignment](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/32_channel_2015/eeg_cap_cable_connector_pinouts.pdf)
* [Custom 32Ch Cap Order Form](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/32_channel_2015/CustomCapOrderForm_Pre2015.pdf)
* [32 Channel Cap Diagram](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/32_channel_2015/NSC32_cap_diagram.pdf)
* [32 Channel Cap Connector Diagram](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/32_channel_2015/NSC32_connector_diagram.pdf)
* [32 Channel Pinout](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/32_channel_2015/PinOut-32_2015.xls)
* [Synamps2 Pinout](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/32_channel_2015/SynAmps2 PinOut.pdf)

## 64 Channel Caps
* ![64 Channel Cap Diagram](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/64_channel/64channel.JPG)
* [Custom 32Ch Cap Order Form](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/64_channel/custom64capform.pdf)
* [64 Channel Pinout](https://github.com/jjcurtin/psychophysiology/blob/main/eeg/64_channel/PinOut64.xls)
...
2.	Cut sensor collars
   ...
   ![collars_orb_corr.png](https://github.com/jjcurtin/psychophysiology/blob/main/sensor_placement/images/images\collars_orb_corr.png)
    * 	For zygomatic, we cut only the inside of the sensor collars to allow the sensors to be placed close together.
   ![collars_zyg.png](https://github.com/jjcurtin/psychophysiology/blob/main/sensor_placement/images/collars_zyg.png)
...
VEOG placement with headbox on participant's left:     ![](https://github.com/jjcurtin/psychophysiology/blob/main/sensor_placement/images/SensorPlacement_VEOGleft.jpg)

VEOG placement with headbox on participant's right:  
![](https://github.com/jjcurtin/psychophysiology/blob/main/sensor_placement/images/SensorPlacement_VEOGright.jpg)
