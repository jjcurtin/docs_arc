...
NOTES: To use in a job, do *not* use the instructions from the above guide, with "universe = container" and "container_image = ". That *is* the way of the future, however *right now* to run on the OSPool and CHTC, you'll want to use this instead: 
universe = vanilla
